...
Kemudian kita mahu menggunakan jawapan tersebut di tempat lain, 
tetapi kita tidak mahu membuat pengiraan semula. 
Jadi, kita boleh menggunakan variable untuk menyimpan 
jawapan tersebut dan terus guna di tempat yang kita mahu.
...
/*
Untuk menyimpan data dalam variable tersebut, 
tulis nama variable, kemudian tulis simbol
= diikuti dengan data. Contoh,
*/
...
/*
Berikut adalah contoh program menggunakan variable 
untuk menyimpan pelbagai jenis data, 
dan cara untuk menggunakannya:
*/
...
/*
Variable hanya boleh menyimpan satu data pada satu masa.
Apabila kita masukkan data yang lain pada variable yang sama, 
data yang asal akan digantikan dengan data yang baru:
*/
...
/*
Kita boleh menggunakan data yang asal untuk digunakan dalam mana-mana operasi,
kemudian masukkan kembali ke variable yang sama. Contoh:
*/
...
Kita perlu menulis jenis data kerana 
ada sesetengah operasi yang boleh digunapakai
oleh lebih dari satu jenis data.
Contohnya, jika kita tambah dua nombor, kita akan dapat jumlahnya.
Tetapi jika kita tambah dua string, kita menggabungkan dua string tersebut.
*/
